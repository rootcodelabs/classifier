...
-- changeset kalsara Magamage:classifier-script-v5-changeset1
CREATE TYPE Validation_Status AS ENUM ('success', 'fail', 'in-progress');

-- changeset kalsara Magamage:classifier-script-v5-changeset2
