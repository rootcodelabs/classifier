          ...
          {dialogProps && (
            <RadixDialog.Root open={isOpen} onOpenChange={close}>
              <RadixDialog.Portal>
                ...
                <RadixDialog.Content className={clsx('dialog', `dialog--${dialogProps.size || 'default'}`)}>
                  {dialogProps.title && (
                    <div className="dialog__header">
                      <RadixDialog.Title className="h3 dialog__title">{dialogProps.title}</RadixDialog.Title>
                  ...
                  {dialogProps.footer && (
                    <Track className="dialog__footer" gap={16} justify="end">{dialogProps.footer}</Track>
                  )}
                </RadixDialog.Content>
              </RadixDialog.Portal>
            </RadixDialog.Root>
